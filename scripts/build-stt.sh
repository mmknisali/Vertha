...
SRC_DIR="$PROJECT_ROOT/src/stt"
DIST_DIR="$PROJECT_ROOT/resources/stt-server"
...
pyinstaller \
    ...
    --hidden-import=speechbrain.inference.encoders \
    --hidden-import=speechbrain.models \
