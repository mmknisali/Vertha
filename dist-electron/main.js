...
import require$$1$1, { app, ipcMain, dialog, BrowserWindow } from "electron";
...
function requireCodegen$1() {
  ...
  (function(exports) {
    ...
    const code_1 = /* @__PURE__ */ requireCode$3();
    const scope_1 = /* @__PURE__ */ requireScope$2();
    ...
    var scope_2 = /* @__PURE__ */ requireScope$2();
...
function requireFormat$3() {
  ...
  const format_1 = /* @__PURE__ */ requireFormat$4();
...
function requireSource() {
  ...
  (function(module, exports) {
    ...
    const ajv_1 = /* @__PURE__ */ requireAjv$1();
...
async function findAvailablePort(startPort, maxTries = 5) {
  ...
  for (let i = 0; i < maxTries; i++) {
    ...
    try {
      const available = await new Promise((resolve2, reject) => {
...
async function startService(serviceName, serviceType, port) {
  ...
  proc.on("close", (code2) => {
    if (code2 !== 0 && code2 !== null) {
      log.error(`${serviceName} exited with code ${code2}`);
    }
  });
  return proc;
}
